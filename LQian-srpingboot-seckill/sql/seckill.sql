...
CREATE TABLE `sk_goods` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '鍟嗗搧ID',
  `goods_name` varchar(30) DEFAULT NULL COMMENT '鍟嗗搧鍚嶇О',
  `goods_title` varchar(64) DEFAULT NULL COMMENT '鍟嗗搧鏍囬',
  `goods_img` varchar(64) DEFAULT NULL COMMENT '鍟嗗搧鍥剧墖',
  `goods_detail` longtext COMMENT '鍟嗗搧璇︽儏',
  `goods_price` decimal(10,2) DEFAULT NULL,
  `goods_stock` int(11) DEFAULT '0' COMMENT '鍟嗗搧搴撳瓨锛?1琛ㄧず娌℃湁闄愬埗',
  PRIMARY KEY (`id`)
...
INSERT INTO `sk_goods` VALUES ('2', 'iphone6', 'Apple/苹果iPhone X 全网通4G手机苹果X 10', '/img/meta10.png', 'Apple/苹果iPhone X 全网通4G手机苹果X 10', '4199.00', '100');
...
-- ----------------------------
INSERT INTO `sk_goods_seckill` VALUES ('1', '1', '0.01', '7', '2018-05-22 17:22:52', '2018-05-22 18:23:00', '1');
...
INSERT INTO `sk_order` VALUES ('11', '18181818181', '11', '1');
...
INSERT INTO `sk_order_info` VALUES ('11', '18181818181', '1', null, null, '1', null, '1', '0', '2018-10-16 17:08:33', null);
