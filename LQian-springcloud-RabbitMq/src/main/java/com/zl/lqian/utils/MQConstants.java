...
public class MQConstants {
	...
	/**你的业务交换机名称*/
	public static final String BUSINESS_EXCHANGE = "zhanglei.exchange";
	/**你的业务队列名称*/
	public static final String BUSINESS_QUEUE = "zhanglei.queue";
	/**你的业务key*/
	public static final String BUSINESS_KEY = "zhanglei.key";
